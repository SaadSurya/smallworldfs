...
Since we are a money transfer company this test will revolve around a (very) simplified transaction model. Our aim is to implement the methods listed in `com.smallworld.TransactionDataFetcherTest`, a component that allows us to get some insight into the transactions our system has.
